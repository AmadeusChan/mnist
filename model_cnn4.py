...
f = file( "result_of_cnn_4.txt", "a" )
f.write('\n')
f.close()

saver = tf.train.Saver()
model_name = "convolutional_multilayer_network_4"
...
for _ in range(1000000):
	...
	if _%50==0:
		...
		print( "step %d, training accuracy %g, validation accuracy %g, highest validation accuracy %g"%(_, train_accuracy, valid_accuracy, highest_valid_accuracy) )
		f = file( "result_of_cnn_4.txt", "a" )
...
f = file( "prediction_by_convolutional_multilayer_network_4.csv", "w" )
